...
switch (process.env.SOFTWARE) {
    case 'misskey':
        instance = new MisskeyDriver(process.env.INSTANCE_URL, process.env.ACCESS_TOKEN);
        break;
    case 'mastodon':
        ...
        instance = new MastodonDriver(process.env.INSTANCE_URL, process.env.ACCESS_TOKEN, process.env.BOT_USERNAME);
        break;
}
